...
import "../styles/ModelTownEarning.css";
const ModelTownEarning = () => {
  const username = localStorage.getItem("username");
  const { isPending, error, data, refetch } = useQuery({
    queryKey: ["IqbalTown"],
    queryFn: () =>
      axios.get("/agents/branchearning/dailyEarningsIqbalTown").then((res) => {
        return res.data;
      }),
  });
  console.log(data);
  return (
    <div className="IqbalTownEarningContainer">
      <Header routeName="Iqbal Town Earning" />
...
export default ModelTownEarning;
